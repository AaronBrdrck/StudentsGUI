...
public class ByGradeSortController extends LoadModuleController {

    /**
     * Takes all the grades in the text area and sorts them by highest grade
     *
     ...
     */
    public ByGradeSortController(TextArea area2, TextArea results, ArrayList<Student> students, ComboBox<String> studentNames1, ComboBox<String> studentNames2){
